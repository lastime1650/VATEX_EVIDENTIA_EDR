...
#include "session/ProcessSession.hpp"
...
namespace EDR
{
    namespace Util
    {
        namespace eBPF
        {
            ...
            namespace queue
            {
                struct queue_s
                {
                    ...
                    struct
                    {
                        ...
                        {
                            /*
                                SHA256 후속처리를 위해 미리 FileDescriptor 획득 
                            */
                            int self_exe_file_fd = 0;
                            int parent_exe_file_fd = 0;
                        }ProcessCreation;
            ...
            namespace RingBufferHandlerCTX
            {
                struct RingBufferHandlerCTX_s
                {
                    std::string& AGENT_ID;
                    EDR::Session::Process::ProcessSession& ProcessSessionManager;
                    EDR::Session::Network::NetworkSession& NetworkSessionManager;
                    EDR::Util::Queue::Queue<queue::queue_s>& Queue;
                };
            }
        }
